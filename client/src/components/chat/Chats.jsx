...
import ExploreUser from "./ExploreUsers";
...
const ExploreTab = () => {
  ...
  return users.map((user) => <ExploreUser key={user._id} {...user} />);
};
...
const RequestsTab = () => {
  ...
  return requests.map((request) => <Requests key={request._id} {...request} />);
};
      ...
      >
        <Stack direction="row" justifyContent="space-between" marginBottom={1}>
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <IconButton>
              <CircleDashed size={20} color="#080707" />
            </IconButton>
          </Stack>
        </Stack>
